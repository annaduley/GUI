...
class MyGUI:
    def __init__(self):
        ...
        self.prompt_label = tkinter.Label(self.top_frame,text='Delivery address:')
        self.prompt_label.pack(side='left')
        self.email_entry = tkinter.Entry(self.top_frame,width=10)
        ...
        self.ok_button = tkinter.Button(self.bottom_frame,
                                        text='Review Order', command=self.calculate)
